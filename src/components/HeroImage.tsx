	...
	return (
		<main className='relative flex flex-col justify-center w-full min-h-screen bg-dark text-light overflow-hidden'>
			<section className='container flex flex-col items-center mx-auto'>
				<div className='relative text-2xl md:text-4xl xl:text-5xl font-semibold text-primary'>
					Líbrate a ti mismo
				</div>
				<AnimatedText
					text='DOMINA TU MENTE MONETIZA TU VIDA'
					className='!text-light text-2xl md:!text-6xl xl:!text-7xl '
				/>
				<div className='font-semibold text-primary text-md md:text-2xl xl:text-2xl mb-8'>
